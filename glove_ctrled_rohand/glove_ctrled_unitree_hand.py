...
class Application:
    ...
    async def main(self):
        ...
        while not self.terminated:
            ...
            if target_changed:
                if Global.hand_position == "left":
                    publisher = Global.l_publisher
                else:
...
if __name__ == "__main__":
    ...
    r_publisher.Init()
    Global.l_publisher = l_publisher
    Global.r_publisher = r_publisher
    Global.hand_position = args.hand
